  ...
  return (
    <section className="py-24 px-6 relative overflow-hidden" ref={sectionRef}>
      ...
      <div
        ...
        style={{
          background: "radial-gradient(ellipse 60% 60% at 50% 50%, hsla(195, 100%, 50%, 0.08) 0%, transparent 60%)",
        }}
      />
      ...
      <div className="container max-w-3xl mx-auto relative z-10">
        ...
        >
          <h2 className="reveal text-3xl md:text-5xl font-bold mb-5 tracking-tight" style={{ textWrap: "balance" }}>
            Pronto para poupar <span className="text-gradient">Milhares de Euros?</span>
          </h2>
          ...
          <div className="reveal mb-8" style={{ transitionDelay: "160ms" }}>
            <Button variant="cyan" size="xl" onClick={() => navigate("/vender")}>
