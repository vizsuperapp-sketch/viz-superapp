...
// Dados com imagens reais de alta resolução que funcionam sempre
const properties = [
  {
    slug: "machado-santos",
    name: "Edifício Machado Santos",
    region: "Margem Sul",
    // Imagem 1: Fachada Moderna
  ...
  },
  {
    ...
    region: "Lisboa",
    // Imagem 2: Vista de Luxo (Garante que esta imagem apareça agora!)
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 max-w-6xl mx-auto">
          {properties.map((property) => (
            <Link key={property.slug} to={`/imoveis/${property.slug}`} className="group block">
              <div className="relative bg-[#0B1120] rounded-[3rem] overflow-hidden border border-slate-800 transition-all duration-700 hover:border-cyan-500/50 hover:shadow-[0_0_60px_rgba(6,182,212,0.2)] hover:-translate-y-4">
                {/* Imagem com Zoom e Reflexo */}
                <div className="aspect-[16/10] overflow-hidden relative">
                  ...
                  />
                  {/* Efeito de Vidro por cima da foto */}
                  <div className="absolute inset-0 bg-gradient-to-t from-[#0B1120] via-transparent to-transparent opacity-90" />
                  <div className="absolute top-4 left-8 right-16 h-1/4 bg-gradient-to-br from-white/10 to-transparent rounded-full rotate-1 blur-[1px] pointer-events-none opacity-40" />
                ...
                <div className="p-10">
                  ...
                  <div className="flex items-center justify-between border-t border-slate-800/50 pt-8">
                    <div className="flex flex-col">
                      <span className="text-[10px] text-slate-500 uppercase font-bold tracking-[0.2em] mb-1">
                        Investimento
                      </span>
                    ...
                    <div className="w-14 h-14 rounded-2xl bg-slate-900 flex items-center justify-center text-white border border-white/5 transition-all group-hover:bg-cyan-500 group-hover:shadow-[0_0_30px_rgba(6,182,212,0.4)]">
