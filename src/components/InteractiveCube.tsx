    ...
    <div className="flex flex-col items-center select-none relative">
      ...
      <div
        ...
        style={{
          ...
          background: "radial-gradient(ellipse 90% 70% at 50% 50%, hsla(211,80%,55%,0.25) 0%, transparent 70%)",
          filter: "blur(28px)",
        }}
      />
      ...
      <div
        ...
        style={{
          ...
          background: "radial-gradient(circle, hsla(211,80%,60%,0.15) 0%, hsla(163,40%,55%,0.06) 40%, transparent 70%)",
          filter: "blur(50px)",
        }}
      />
      ...
      >
        ...
        >
          <span className="text-[10px] font-semibold uppercase tracking-[0.15em] px-2 py-1 rounded-full"
            style={{ color: "hsla(0,0%,100%,0.7)", background: "hsla(211,80%,55%,0.12)", border: "1px solid hsla(211,60%,70%,0.15)", backdropFilter: "blur(8px)" }}>
            Zero comissão
          </span>
        </div>
        <div
        ...
        >
          {faces.map((face, i) => (
            <CubeFace key={i} letter={face.letter} size={cubeSize} style={{ transform: faceTransforms[i] }} />
          ))}
          ...
          <div className="absolute" style={{
            ...
            background: "radial-gradient(circle, hsla(211,80%,60%,0.5) 0%, hsla(163,50%,55%,0.2) 40%, transparent 70%)",
          ...
          {[
            ...
            <div key={i} className="absolute pointer-events-none" style={{
              ...
              boxShadow: "0 0 8px 3px hsla(211,70%,70%,0.6)",
  ...
  return (
    <div
      ...
      style={{
        ...
        background: `linear-gradient(145deg, hsla(163,50%,60%,0.35) 0%, hsla(190,60%,55%,0.28) 30%, hsla(211,70%,60%,0.25) 60%, hsla(211,80%,55%,0.3) 100%)`,
        backdropFilter: "blur(12px) saturate(1.4)",
        WebkitBackdropFilter: "blur(12px) saturate(1.4)",
        border: "1.5px solid hsla(0,0%,100%,0.5)",
        boxShadow: `inset 0 1px 0 hsla(0,0%,100%,0.4), inset 0 -1px 0 hsla(211,60%,45%,0.06), 0 8px 32px hsla(211,60%,40%,0.1)`,
    ...
    >
      ...
      <div className="absolute pointer-events-none" style={{
        top: 6, left: 6, right: "30%", height: "20%",
        background: "linear-gradient(135deg, hsla(0,0%,100%,0.4) 0%, hsla(0,0%,100%,0.05) 50%, transparent 100%)",
      ...
      {letter && (
        <span style={{
          ...
          textShadow: "0 0 30px hsla(211,80%,60%,0.5), 0 2px 8px hsla(211,60%,40%,0.3)",
